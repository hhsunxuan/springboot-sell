...
public class SeckillServiceImpl implements SeckillService {
    ...
    //Redis是单线程的!!!
    @Override
    public void orderProductMockDiffUser(String productId) {//解决方法一:synchronized锁方法是可以解决的，但是请求会变慢,请求变慢是正常的。主要是没做到细粒度控制。比如有很多商品的秒杀，但是这个把所有商品的秒杀都锁住了。而且这个只适合单机的情况，不适合集群
